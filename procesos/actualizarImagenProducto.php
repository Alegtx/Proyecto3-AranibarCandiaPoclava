                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6 col-md-offset-3 text-center">
                        <?php
                            ...
                            if(!$_FILES['img-prod']['name'] == "")
                            {
                                if(move_uploaded_file($_FILES['img-prod']['tmp_name'],"../assets/img-productos/".$_FILES['img-prod']['name']))
                                {
                                    //Con la fecha en UTC
                                    date_default_timezone_set('UTC');
                                    //Renombrar el archivo con la fecha y hora por delante para que no se repitan los nombres
                                    rename ("../assets/img-productos/".$_FILES['img-prod']['name'], "../assets/img-productos/".date("Y-m-d_H.i.s")."_".$_FILES['img-prod']['name']);
                                    if(consultasSQL::UpdateSQL("producto", "Imagen = '".date("Y-m-d_H.i.s")."_".$_FILES['img-prod']['name']."'", "CodigoProd = '".$_POST['cod-prod-img']."'"))
                                    {
