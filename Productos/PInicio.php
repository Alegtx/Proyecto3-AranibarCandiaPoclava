...
<html lang="es">
	...
	<body>
		...
		<fieldset>
			...
			<center>
			<form action="PInicio.php" method="post">
				<table border="15">
					<tr>
						<th>Codigo del Producto</th><th><input type="text" name="cod"></th>
					</tr>
					<tr>
						<th>Nombre:</th><th><input type="text" name="nom"></th>
					</tr>
					<tr>
						<th>Stock:</th><th><input type="text" name="stock"></th>
					</tr>
					<tr>
						<th>Precio</th><th><input type="text" name="precio"></th>
					</tr>
				</table><br>
				<input id="e" type="submit" value="Registrar">
			</form><br>
			<a href="PModificar.php"><input id="j" type="submit" value="Modificar"></a>
			<a href="PEliminar.php"><input id="j" type="submit" value="Eliminar"></a>
			<a href="PConsulta.php"><input id="j" type="submit" value="Consulta"></a>
			<a href="PStock.php"><input id="j" type="submit" value="Registros"></a>
			</center><br><br><hr>
			<div>
				<h1>Resultados</h1>
				<?php
					...
					if ($reg=mysqli_fetch_array($registros))
					{
						...
						else
						{
							...
							else
							{
								...
								$conexion=retornarConexion();
								mysqli_query($conexion,"insert into productos(CodProducto,Nombre,Cantidad,Precio,CodCateg) values ('$codigo','$nombre','$stock','$precio')") or die("Problemas en el select".mysqli_error($conexion));
								mysqli_close($conexion);
