...
<html lang="es">
	...
	<body background="super2.jpg">
		...
		<center>
		<fieldset>
			<h1>Lista de Personas</h1><hr><br><br>
			<div style="width:750px;height:400px;overflow:auto;">
				<?php
					...
					{
						echo "<center>"."<b>CI:     </b>".$reg['CI']."<br>";
						echo "<b>Nombre:     </b>".$reg['Nombre']."<br>";
						echo "<b>Paterno:      </b>".$reg['Ap_paterno']."<br>";
						echo "<b>Materno:     </b>".$reg['Ap_materno']."<br>";
						echo "<b>Direccion:     <b>".$reg['Direccion']."<br>";
						echo "<b>Telefono:     </b>".$reg['Telefono']."<br>";
						echo "<b>Celular:     </b>".$reg['Celular']."<br>";
						echo "<b>Whatsapp:     </b>";
						switch ($reg['whatsaap'])
						{
							case 0: 
						...
						echo "<b>Fecha De Nacimiento:     </b>".$reg['Fecha_Nacimiento']."<br>";
						echo "<b>Genero:     </b>";
						switch ($reg['Genero'])
						{
							case 0: 
						...
						echo "<b>Tipo de Sangre:     </b>".$reg['T_Sangre']."<br>";
						echo "<b>Nacionalidad:     </b>".$reg['Nacionalidad']."<br>";
						echo "<b>Correo:     </b>".$reg['Correo']."<br>";
						echo "<b>Foto:     </b>".$reg['Foto']."<br>";
						echo "<br>";
						echo "<hr>"."</center>";
					}
				?>
